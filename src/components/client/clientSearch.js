...
export default class ClientSearch extends React.Component {
	...
	onFilterChange(text) {
		...
		interval = setTimeout(() => {
			ClientStore.getClients(this.state.filterText);
		}, 1000);
	}
	componentDidMount() {
				...
				<View style={styles.content}>
					<View style={styles.userProfileWrapper}>
						<View style={styles.profile}>
							...
							<Text style={styles.profileName}>Mogen Polish</Text>
							<Text style={styles.profileProfession}>Writer, Mag Editor</Text>
						</View>
					...
					<View style={styles.profileDetailWrapper}>
						...
						<View style={styles.profileInfo}>
							...
							<Text style={styles.infoValue}>Muhammed Jasim</Text>
						</View>
						<View style={styles.profileInfo}>
